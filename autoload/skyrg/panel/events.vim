" autoload/skyrg/panel/events.vim — Lightweight event bus
"
" Decouples cross-panel updates. Panels register listeners, and any module
...
"
" Usage:
"   call skyrg#panel#events#on('results_changed', function('s:my_handler'))
