" autoload/skyrg/ui/popup.vim — Popup factory with shared defaults
"
" Generic popup creation/move with consistent styling (Normal highlight,
" rounded borders, etc.). No domain knowledge.
"
" Usage:
"   let id = skyrg#ui#popup#create(content, {
"     \ 'title': ' Results ',
...
function! skyrg#ui#popup#create(content, opts) abort
...
function! skyrg#ui#popup#move(id, opts) abort
  let l:o = copy(a:opts)
