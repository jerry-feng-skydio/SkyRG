" autoload/skyrg/ui/keymap.vim — Configurable key bindings
"
...
function! skyrg#ui#keymap#get() abort
  if !empty(s:merged)
    return s:merged
  endif
