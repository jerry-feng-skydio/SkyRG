" autoload/skyrg/ui/util.vim — Shared utilities
"
" Design notes:
...
"   skyrg#ui#util#line('hello')           → {'text': 'hello'}
"   skyrg#ui#util#line('hello', [props])  → {'text': 'hello', 'props': [...]}
function! skyrg#ui#util#line(text, ...) abort
  if a:0 > 0 && !empty(a:1)
...
"   skyrg#ui#util#hl_line('selected item', 'skyrg_sel')
function! skyrg#ui#util#hl_line(text, hl_type) abort
...
function! skyrg#ui#util#del_word(f) abort
...
function! skyrg#ui#util#short(path) abort
  let l:cwd = getcwd() . '/'
